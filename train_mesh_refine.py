...
# python train_mesh_refine.py --config configs/mesh/MB_ft_HybrIK.yaml  --evaluate checkpoint/mesh/FT_MB_HybriIK/best_epoch.bin
import logging
import os
import random
import copy
...
from lib.model.model_mesh_refine import MeshRegressor
from torch.utils.data import DataLoader
