...
def generate_bvh(cfg, camera_keypoints_3d):
    ...
    from inference.tool.bvh.generator.smartbody_skeleton import SmartBodySkeleton
    from inference.tool.bvh.generator.h36m_skeleton import H36mSkeleton
...
def main(cfg, vid_size, vid_fps):
    ...
    # 3. generate bvh file
    generate_bvh(cfg, prediction_camera_3d)
