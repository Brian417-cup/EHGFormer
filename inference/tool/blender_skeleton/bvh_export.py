# Save *.bvh file in custom way: -Z upm -y forward Eular ZXY
# That means, it's same with OpenGL cooridnate system
# Refered from https://github.com/Brian417-cup/blender_bvh_addon_enhanced/blob/main/io_anim_bvh_enhanced/export_bvh_enhanced.py
def write_armature(
        context,
        filepath,
        frame_start,
    ...
    for frame in range(frame_start, frame_end + 1):
        ...
        for dbone in bones_decorated:
            ...
            file.write("%.6f %.6f %.6f " % (
                degrees(rot[dbone.rot_order[0]]), degrees(rot[dbone.rot_order[1]]), degrees(rot[dbone.rot_order[2]])))
