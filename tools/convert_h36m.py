...
def get_args():
    ...
    parser.add_argument('-out_dir', type=str, default=r'data/motion3d/H36M-SH/init_overlap',
    ...
    parser.add_argument('-tds', type=int, default=1, help='Temporal downsampling for both train and test dataset.')
    parser.add_argument('-f', type=int, default=243, help='The input sequence length.')
    parser.add_argument('-s', type=int, default=81,
                        help='Data sample stride strategy. Except MixSTE, other method use overlaped data sampling strategy.')
...
# This is for init MotionBERT(Overlapping data sample strategy like VideoPose3D)
