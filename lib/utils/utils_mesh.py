...
import copy
import cv2
from lib.utils.rotation_conversion import axis_angle_to_matrix, matrix_to_rotation_6d
...
def rot6d_to_rotmat_for_deployment(x):
    x = x.reshape(-1, 3, 2)
...
def evaluate_mesh(results):
    def compute_squared_difference(pred_verts, target_verts, chunk_size):
        '''
        cacualte in chunk way due to limit storage
        :param pred_verts:
        :param target_verts:
        :param chunk_size:
        :return:
    ...
    # remove copy for memory out problem
