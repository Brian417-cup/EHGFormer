    ...
    def __init__(self, args, data_split, dataset):  # data_split: train/test; dataset: h36m, coco, pw3d
        ...
        if dataset == "h36m":
            ...
            datareader = DataReaderMesh(n_frames=1, sample_stride=args.sample_stride, data_stride_train=1,
                                        ...
                                        res=[640, 640])
            # datareader = DataReaderMesh(n_frames=1, sample_stride=args.sample_stride, data_stride_train=args.data_stride, data_stride_test=self.clip_len, dt_root=args.data_root, dt_file=args.dt_file_coco, res=[640, 640])
        elif dataset == "pw3d":
